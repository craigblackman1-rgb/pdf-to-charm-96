      ...
      <DialogContent className="sm:max-w-md bg-background border-border">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-2">
          ...
          <div>
            ...
            <Textarea
              name="goals"
              placeholder="E.g. I want to improve my mobility and build strength after an injury..."
              maxLength={1000}
              rows={3}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-full font-medium hover:opacity-90 transition-opacity disabled:opacity-60"
          >
