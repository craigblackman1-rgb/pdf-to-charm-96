    ...
    <section className="py-20 md:py-28 bg-background">
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl text-foreground mb-3">Who Esther Works With</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { src: s1, label: "Cancer Rehabilitation", desc: "Specialist support during treatment, in remission, and post-surgery." },
            { src: s2, label: "Adaptive Training", desc: "Inclusive programmes tailored to your abilities and goals." },
            { src: s3, label: "Injury Recovery", desc: "Safe, structured return to movement after injury or surgery." },
          ].map((img, i) => (
            <div key={i} className="relative rounded-xl overflow-hidden group shadow-md aspect-[4/3]">
              <img
                src={img.src}
                alt={img.label}
                loading="lazy"
