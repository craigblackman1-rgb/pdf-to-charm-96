...
const localBusinessSchema = {
  ...
  "sameAs": [
    "https://www.facebook.com/EternalFitnessPersonalTraining/"
  ],
  "founder": {
    "@type": "Person",
    "name": "Esther Fair",
    ...
    "itemListElement": [
      {
        ...
        "itemOffered": {
          ...
          "description": "60-minute one-to-one personal training session in a private studio in Worthing."
        },
        "price": "45",
        "priceCurrency": "GBP"
      },
      {
        ...
        "itemOffered": {
          ...
          "description": "12 x 60-minute personal training sessions with programme review and adjustment."
        },
        "price": "480",
        "priceCurrency": "GBP"
      },
      {
        ...
        "itemOffered": {
          ...
          "description": "24 x 60-minute personal training sessions with ongoing programme management and priority scheduling."
        },
        "price": "840",
        "priceCurrency": "GBP"
      }
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        canonical="/"
        schema={[localBusinessSchema, personSchema]}
      />
